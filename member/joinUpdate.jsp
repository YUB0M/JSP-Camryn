	...
	<div class="custom-border-bottom py-3">
		<div class="container">
			<div class="row">
				...
				<strong class="text-black">회원정보</strong></div>
			</div>
		</div>
	</div>
						...
						<article class="container">
							<div class="page-header">
								<div class="col-md-6 col-md-offset-3">
									<h4 class="subListname">회원정보 수정</h4>
								</div>
							</div>
							<div class="col-sm-6 col-md-offset-3">
								<form role="form" action="joinupdatePro.jsp" method="post" onsubmit="return joinSubmit()">
									<div class="form-group">
										<label for="InputUserid">아이디</label>
										<div class="idcheck">
											<input type="text" class="form-control" id="userid" name="userid" value="<%=mbean.getUserid() %>" onkeyup="idChk();" readonly><br>
									...
									<div class="form-group">
										...
										<input type="password" class="form-control" id="password" name="password" <%-- value="<%=mbean.getPassword() %>" --%> onkeyup="pwdChk();">
										<span class="inpt_er_text" id="pwd_msg">&nbsp</span>
									</div>
									<div class="form-group">
										<label for="inputPasswordCheck">비밀번호 확인</label>
										<input type="password" class="form-control" id="passwordChk" name="password" <%-- value="<%=mbean.getPassword() %> --%> onkeyup="pwd2Chk();">
										<span class="inpt_er_text" id="pwd2_msg">&nbsp</span>
									</div>
									<div class="form-group">
										<label for="inputName">성명</label>
										<input type="text" class="form-control" id="name" name="name" value="<%=mbean.getName() %>" onkeyup="nameChk();" readonly>
									...
									<div class="form-group">
										...
										<p>
											<input type="text" id="zipcode" name="zipcode" class="inpt_default" value="<%=mbean.getZipcode() %>" onkeyup="zipChk();">
											<input type="button" class="btns_sys red_big_xb" onclick="sample6_execDaumPostcode()" value="우편번호 찾기&nbsp"><br>
											<input type="text" id="addr" name="addr" class="inpt_default" value="<%=mbean.getAddr() %>" style="width:380px;"><br>
											<input type="text" id="addr2" name="addr2" class="inpt_default" value="<%=mbean.getAddr2() %>" style="width:380px;">
									...
									<div class="form-group">
										...
										<input type="phone" class="form-control" id="phone" name="phone" value="<%=mbean.getPhone() %>" onkeyup="phChk();">
										<span class="inpt_er_text" id="ph_msg">&nbsp</span>
									</div>
									<div class="form-group">
										<label for="InputBirth">생년월일</label>
										<input type="birth" class="form-control" id="birth" name="birth" value="<%=mbean.getBirth() %>" onkeyup="bthChk();" readonly>
